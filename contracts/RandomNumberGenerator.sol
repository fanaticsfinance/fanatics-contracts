...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public fanaticsFinanceLottery;
     ...
     * @param _seed: seed provided by the FanaticsFinance lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == fanaticsFinanceLottery, "Only FanaticsFinanceLottery");
    ...
    /**
     * @notice Set the address for the FanaticsFinanceLottery
     * @param _fanaticsFinanceLottery: address of the FanaticsFinance lottery
     */
    function setLotteryAddress(address _fanaticsFinanceLottery) external onlyOwner {
        fanaticsFinanceLottery = _fanaticsFinanceLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFanaticsFinanceLottery(fanaticsFinanceLottery).viewCurrentLotteryId();
    }
}